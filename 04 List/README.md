...
1. List Indexing and Slicing (Positive & Negative).
2. Mutability of Lists (Updating elements and in-place changes).
3. Common List Methods (`.append()`, `.pop()`, `.remove()`).
4. List Operations (Concatenation, Slicing tricks like `[::-1]`).
